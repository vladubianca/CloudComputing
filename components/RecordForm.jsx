...
const RecordForm = (props) => {
  ...
  return (
    <div className="flex justify-center p-4">
      <div className="bg-red-600 border-2 border-black p-4 rounded-md shadow-sm flex flex-col gap-4 w-full max-w-80">
        <div>
          <label
            htmlFor="grand_prix"
        ...
        <div className="w-full flex justify-center gap-4">
            ...
            className="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-red-900"
          >
            Cancel
          </button>
          <button
            ...
            className="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-green-800"
          >
